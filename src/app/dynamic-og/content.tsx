...
export const ContentOGWrapperResponse = async ({ theme, accentColor, ...props }: OgData) => {
  ...
  return new ImageResponse(
    theme === "dark" ? (
      <DarkThemeOG accentColor={themeColor} {...props} />
    ) : (
      <LightThemeOG accentColor={themeColor} {...props} />
    ),
    {
      fonts: [
...
function DarkThemeOG({ title, subtitle, logo }: Omit<OgData, "theme">) {
  return (
    <div
      style={{
        display: "flex",
