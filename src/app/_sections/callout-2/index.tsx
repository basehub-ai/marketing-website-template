...
export function Callout2(callout: Callout2) {
  return (
    <Section>
      <article className="bg-accent- dark:bg-accent-500/10 flex flex-col justify-center gap-9 self-stretch rounded-xl p-6 lg:flex-row lg:justify-between lg:p-10">
