...
export function Header() {
  return (
    <header className="container sticky left-0 top-0 z-10 mx-auto grid h-[--header-height] w-full grid-cols-header place-items-center content-center items-center px-4 first:*:justify-self-start last:*:justify-self-end">
