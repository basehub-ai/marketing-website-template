...
export function Header() {
  return (
    <header className="relative left-0 top-0 z-50 flex h-[--header-height] border-b border-border bg-surface-primary dark:border-dark-border dark:bg-dark-surface-primary">
